...
public class ClientMainFrm extends javax.swing.JFrame {
    ...
    private void initComponents()
    {
        ...
        txtServer = new javax.swing.JTextPane();
        ...
        txtServer.setContentType("text/html"); // NOI18N
        scrollpaneServer.setViewportView(txtServer);
        ...
        serverMsgPanelLayout.setHorizontalGroup(
            ...
            .addComponent(scrollpaneServer, javax.swing.GroupLayout.DEFAULT_SIZE, 485, Short.MAX_VALUE)
        );
        serverMsgPanelLayout.setVerticalGroup(
            serverMsgPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(scrollpaneServer, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE)
        );
    ...
    private void textFieldChatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textFieldChatKeyPressed
        if (evt.getKeyCode() == 10){
            ...
            if(!msg.isEmpty())
            {
                if(msgPanel.getSelectedComponent() == serverMsgPanel)
                    cmc.sendMsg(msg, true);
                else
                    cmc.sendMsg(msg, false);
            }
    ...
    {
        if(cmc.currentChannel.getName().equals("Lobby"))
        {
            if(channelMsgPanel.getParent() == msgPanel)
            {
                msgPanel.remove(channelMsgPanel);
                msgPanel.setSelectedComponent(serverMsgPanel);
            }
            return;
        }
        if(channelMsgPanel.getParent() != msgPanel)
        ...
        txtChannelMsg.setContentType("text/html");
        msgPanel.setTitleAt(1, cmc.currentChannel.getName());
        msgPanel.setSelectedIndex(1);
    }
    ...
    public Channel showEditChannelDialog(Channel channel)
    {
        ...
        {
            //check difference
            if(txtChannelName.getText().equals(channel.getName()) && txtChannelTopic.getText().equals(channel.getTopic()) && txtChannelDesc.getText().equals(channel.getDescription()) && new String(txtChannelPassword.getPassword()).equals(channel.getPassword()))
            {
                JOptionPane.showMessageDialog(this, "No change detected!", "Error", JOptionPane.ERROR_MESSAGE);
                return null;
            }
    ...
    public void printMessage(String sender, String message, String mode)
    {        
        ...
        {
            try {
                HTMLDocument doc = (HTMLDocument) txtServer.getStyledDocument();
                doc.insertAfterEnd(doc.getCharacterElement(doc.getLength()), output);
                JScrollBar vertical = scrollpaneServer.getVerticalScrollBar();
     ...
     */
    public void setFriendFrmPosition()
    {
        if(cff != null)
    ...
    */
    ...
    private javax.swing.JTextPane txtServer;
